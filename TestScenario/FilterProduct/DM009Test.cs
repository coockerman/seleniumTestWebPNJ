...
public class DM009Test {
  ...
  public void dM009() {
    ...
    driver.FindElement(By.CssSelector(".price-slider")).SendKeys("28000000");
    ...
    driver.FindElement(By.CssSelector(".search-btn")).Click();
    driver.FindElement(By.CssSelector(".search-btn")).Click();
    driver.FindElement(By.CssSelector(".filter-section:nth-child(4)")).Click();
    driver.FindElement(By.CssSelector(".filter-section:nth-child(4) .filter-btn:nth-child(1)")).Click();
    driver.FindElement(By.CssSelector(".search-btn")).Click();
  }
}
